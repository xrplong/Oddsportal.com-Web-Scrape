...
leadingYear = 2010  # Choose year lower bound
while leadingYear <= 2020: # Choose year upper bound
    preYear = leadingYear - 1
    page = 1
    max_page = 9999
    rows_list = []

    while page <= max_page:
        driver.get('http://www.oddsportal.com/basketball/usa/nba-' + str(preYear) + '-' + str(leadingYear) + '/results/#/page/' + str(page))
